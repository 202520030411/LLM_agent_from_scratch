...
\begin{frame}{Three Tools, One Purpose}
  \begin{table}
    \begin{tabular}{lll}
      ...
      \midrule
      \texttt{web\_search} & DuckDuckGo & Latest headlines \& current facts \\[4pt]
  ...
  \begin{enumerate}
    \item \texttt{web\_search("US China tariffs 2025")} $\rightarrow$ latest headlines
...
\begin{frame}{Key Design Choices}
  \begin{table}
    \begin{tabular}{ll}
      ...
      DuckDuckGo search & No API key required, no rate-limit costs \\[4pt]
...
\begin{frame}{Summary}
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      ...
      Gradio $\cdot$ DuckDuckGo $\cdot$ Wikipedia
    \end{column}
  \end{columns}
\end{frame}
